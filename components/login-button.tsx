...
export function LoginButton() {
  return (
    ...
    >
      <button 
        type="submit"
        className="flex items-center justify-center gap-2 rounded-full bg-indigo-600 px-6 py-3 text-white transition-all hover:bg-indigo-700 hover:scale-105 shadow-lg font-medium text-lg"
      >
